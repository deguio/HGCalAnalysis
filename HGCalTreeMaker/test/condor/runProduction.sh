...
outDir=/eos/cms/store/group/dpg_hgcal/comm_hgcal/deguio/gen_mu150_20190828/
mkdir -p ${outDir}

cd /afs/cern.ch/work/d/deguio/HGCAL/DigiStudies/CMSSW_11_0_0_pre6_finalNumbers/src/HGCalAnalysis/HGCalTreeMaker/test/condor
